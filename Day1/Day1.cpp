...
public:
  ...
  void moveRight(int moves) {
    ...
    case Direction::NORTH:handleXCoordinate(moves, true);
      coordinate.x += moves;
      currentDirection = Direction::EAST;
      break;
    case Direction::SOUTH:handleXCoordinate(moves, false);
      coordinate.x -= moves;
      currentDirection = Direction::WEST;
      break;
    case Direction::EAST:handleYCoordinate(moves, false);
      coordinate.y -= moves;
      currentDirection = Direction::SOUTH;
      break;
    case Direction::WEST:handleYCoordinate(moves, true);
      coordinate.y += moves;
  ...
  void moveLeft(int moves) {
    ...
    switch (currentDirection) {
    case Direction::NORTH:handleXCoordinate(moves, false);
      coordinate.x -= moves;
      currentDirection = Direction::WEST;
      break;
    case Direction::SOUTH:handleXCoordinate(moves, true);
      coordinate.x += moves;
      currentDirection = Direction::EAST;
      break;
    case Direction::EAST:handleYCoordinate(moves, true);
      coordinate.y += moves;
      currentDirection = Direction::NORTH;
      break;
    case Direction::WEST:handleYCoordinate(moves, false);
      coordinate.y -= moves;
      currentDirection = Direction::SOUTH;
      break;
    }
...
int main() {
  ...
  // parse the line
  token = strtok(buffer, DELIMITER); // first token
  while (token != NULL) {
    printf("%s\n", token);
